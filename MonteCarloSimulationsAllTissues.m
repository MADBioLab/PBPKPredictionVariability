function MonteCarloSimulationsAllTissues(referenceProperties, Nsamples, errorScale, nprocs)
    ...
    MCResults=zeros(Nsamples,Noutputs*Nmodels,Nmolecules,12);
    nominalResults=zeros(Noutputs*Nmodels,Nmolecules,12);
