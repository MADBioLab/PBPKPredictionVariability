function SobolForCorrelatedParamsPBPK(ReferenceData)
    ...
    OutcomeLabels = {'Vss','thalf',...
                     ...
                     'T1uM$_{lung}$','T1uM$_{gut}$','T1uM$_{spleen}$',...
                     'T1uM$_{heart}$','T1uM$_{muscle}$','T1uM$_{adipose}$',...
                     'T1uM$_{kidney}$','T1uM$_{skin}$','T1uM$_{brain}$',...
                     'T1uM$_{bone}$','T1uM$_{liver}$','T1uM$_{RBCs}$',...
                     'ctrl'};
    % number of outcomes
...
function output=PBPK4Sobol(pars)
    ...
    output=[P.Vdeq,P.thalf,P.Kp([1:11,13])',P.Cmaxu',P.AUCu',P.T1uM',P.ctrl];    
end
